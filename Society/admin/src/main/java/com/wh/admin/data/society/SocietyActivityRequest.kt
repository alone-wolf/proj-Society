...
class SocietyActivityRequest {
    ...
    override fun toString(): String {
        return "SocietyActivityRequest(id=$id, societyId=$societyId, societyName='$societyName', userId=$userId, username='$username', userIconUrl='$userIconUrl', isJoin=$isJoin, request='$request', isDealDone=$isDealDone, isAgreed=$isAgreed, activity='$activity')"
    }
}